...
def recommended_calories(total_daily_energy_expenditure, goal, weight):
    ...
    rate = [half_per_week_rate, one_per_week_rate, one_half_per_week_rate, two_per_week_rate]
    # calulating the time to reach your goal
    time_to_lose_@half = need_to_lose/rate[0]
    time_to_lose_@one = need_to_lose/rate[1]
    time_to_lose_@one_half = need_to_lose/rate[2]
    time_to_lose_@two = need_to_lose/rate[3]
    # return all the "time to lose" variables to spit back out
    return rate, time_to_lose_@half, time_to_lose_@one, time_to_lose_one_@half, time_to_lose_@two